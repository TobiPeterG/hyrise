...
void SecondChanceEviction::on_access(const PageID& /*page_id*/, Frame* const frame) {
  // record that the frame was referenced.
  // for second-chance we only need a boolean.
